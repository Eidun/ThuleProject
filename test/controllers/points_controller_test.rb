...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { category: @point.category, completed: @point.completed, name: @point.name, quest_id: @point.quest_id } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { category: @point.category, completed: @point.completed, name: @point.name, quest_id: @point.quest_id } }
